...
export const MOCK_INVOICES: Invoice[] = [
  {
    ...
    status: "ready",
    fields: [
      { key: "vendor_name", label: "Vendor", value: "Amazon Web Services", type: "text" },
      ...
      { key: "tax_amount", label: "Tax (20%)", value: "768.00", type: "currency" },
      { key: "total_amount", label: "Total", value: "4608.00", type: "currency" },
  ...
  },
  {
    ...
    status: "ready",
    fields: [
      { key: "vendor_name", label: "Vendor", value: "Stripe Inc.", type: "text" },
      ...
      { key: "tax_amount", label: "Tax (20%)", value: "250.00", type: "currency" },
      { key: "total_amount", label: "Total", value: "1500.00", type: "currency" },
